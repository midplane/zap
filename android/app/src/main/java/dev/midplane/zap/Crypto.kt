...
object Crypto {
    ...
    private fun point(raw: ByteArray): ECPublicKey {
        ...
        return KeyFactory.getInstance("EC").generatePublic(ECPublicKeySpec(ECPoint(java.math.BigInteger(1, raw.copyOfRange(1, 33)), java.math.BigInteger(1, raw.copyOfRange(33, 65))), curve)) as ECPublicKey
    }
